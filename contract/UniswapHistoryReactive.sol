...
import "./system/IReactive.sol";
import "./system/AbstractPausableReactive.sol";
import "./system/ISubscriptionService.sol";
...
contract UniswapHistoryReactive is IReactive, AbstractPausableReactive {
    event Sync(address indexed pair, uint256 indexed block_number, uint112 reserve0, uint112 reserve1);
    ...
    function getPausableSubscriptions() internal pure override returns (Subscription[] memory) {
        ...
        result[0] = Subscription(
            SEPOLIA_CHAIN_ID, address(0), UNISWAP_V2_SYNC_TOPIC_0, REACTIVE_IGNORE, REACTIVE_IGNORE, REACTIVE_IGNORE
        );
        return result;
    }
